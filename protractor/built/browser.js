...
const selenium_webdriver_1 = require('../selenium-webdriver');//require('selenium-webdriver');
...
const Command = require('../selenium-webdriver/lib/command').Command;//require('selenium-webdriver/lib/command').Command;
const CommandName = require('../selenium-webdriver/lib/command').Name;//require('selenium-webdriver/lib/command').Name;
// jshint browser: true
